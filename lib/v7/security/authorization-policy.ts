...
const actionRoles: Record<ActionKey, RoleKey[]> = {
  ...
  "monthly_submission.write": ["super_admin", "webmaster_admin", "gerente_operaciones", "gerente_area", "gerente_sucursal", "usuario_operativo"],
  "monthly_submission.publish": ["super_admin", "webmaster_admin", "gerente_operaciones", "gerente_area"],
  "imports.read": ["super_admin", "webmaster_admin", "ceo", "gerente_operaciones", "gerente_area", "viewer"],
  "imports.write": ["super_admin", "webmaster_admin", "gerente_operaciones"],
  ...
  "users.read": ["super_admin", "webmaster_admin", "ceo", "gerente_operaciones", "gerente_area", "gerente_sucursal"],
  "users.invite": ["super_admin", "webmaster_admin", "ceo", "gerente_operaciones", "gerente_area", "gerente_sucursal"],
