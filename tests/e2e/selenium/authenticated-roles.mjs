  ...
  for (const fixture of closingFixtures) {
    ...
    const kpis = await admin.from("closing_kpi_results").insert([
      ...
      },
      {
        ...
        formula_version: "qa-fixture-v1",
        is_demo: false,
        kpi_code: fixture.line === laboratoryLine.data.id ? "lab_total_orders" : "physio_therapy_sessions",
        kpi_name: fixture.line === laboratoryLine.data.id ? "Órdenes QA" : "Sesiones QA",
        unit: fixture.line === laboratoryLine.data.id ? "ordenes" : "sesiones",
